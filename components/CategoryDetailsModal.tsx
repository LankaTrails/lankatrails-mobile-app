            ...
            <View style={styles.summarySection}>
                ...
                <View style={styles.categoryInfo}>
                  ...
                  {category.allocated > 0 && (
                    <Text style={styles.categoryLimit}>
                      Limit: {currencyType} {category.allocated.toLocaleString()}
                    </Text>
                  )}
                </View>
              </View>
                    ...
                    <View 
                      style={[
                        ...
                        { 
                          ...
                          backgroundColor: (category.spent / category.allocated) >= 0.9 ? '#EF4444' : 
                                         (category.spent / category.allocated) >= 0.75 ? '#F59E0B' : category.color
                        }
                      ]} 
                    />
                  </View>
              ...
              >
                <Text style={styles.editButtonText}>
                  {category.allocated > 0 ? 'Edit Budget Limit' : 'Set Budget Limit'}
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.expensesSection}>
              ...
              {categoryExpenses.length > 0 ? (
                ...
                <View style={styles.noExpenses}>
                  ...
                  <Text style={styles.noExpensesText}>No expenses in this category yet</Text>
                  <Text style={styles.noExpensesSubtext}>
                    Add your first expense to start tracking spending in {category.name}
                  </Text>
                </View>
              )}
            </View>
