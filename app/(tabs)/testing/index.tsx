...
//   const AnimatedCard = ({ children, delay = 0 }: { children: React.ReactNode; delay?: 0 }) => {
...
//             }}
//           >
//             <View className="h-24 bg-gradient-to-br from-orange-200 to-pink-200 rounded-t-xl relative overflow-hidden mr-3">
...
//             </View>
//             <View className="p-4">
//               <Text className="text-2xl font-bold text-gray-800 mb-2 justify-center ml-3 mr-3">
