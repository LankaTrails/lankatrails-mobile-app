...
import { AlertCircle, Info, Star } from "lucide-react-native";
...
const ActivityServiceDetailPage = () => {
  ...
  const checkIfFavorite = (
    serviceDetail: ActivityServiceDetail,
        ...
        {/* <View className="px-4 py-6 bg-white">
          <View className="items-center">
            ...
            <Text className="text-lg text-gray-600 capitalize">
              {serviceDetail.activityType.toLowerCase().replace("_", " ")}{" "}
              Activity
            </Text>
          </View>
        </View> */}
        ...
        <View className="p-5">
          ...
          <View className="bg-white rounded-lg p-4 mb-4 shadow-sm">
            <View className="flex-row items-center mb-3">
              <Info size={20} color="#008080" />
              <Text className="ml-2 font-semibold text-gray-800">
                Description
              </Text>
            </View>
            <Text className="text-gray-600 leading-6">
              {serviceDetail.activityDetails}
            </Text>
          </View>
          ...
          <View className="bg-white rounded-lg p-4 mb-4 shadow-sm">
            ...
            <Text className="text-gray-600 leading-6">
              {serviceDetail.safetyInstructions}
            </Text>
          </View>
        </View>
...
export default ActivityServiceDetailPage;
